...
const projects = [
  {
    name: "CleanGraphQL",
    description:
      "Minimalistisches Cleanarchitecture basiertes projekt mit graphql",
  ...
  },
  {
    name: "TodoApp",
    description:
      "Eine TodoApp ohne tracking und nur local storage mit React, TS und Docker.",
  ...
  },
  {
    ...
    description:
      "Ein beispielprojekt, um zu zeigen wie WPF richtig funktioniert.",
    githubLink:
      "https://github.com/Nivisan-Jeyananthan/Professional-Modern-WPF-UI",
    githubIcon: "fab fa-github",
  },
  {
    name: "TicTacToe",
    description:
      "Das berühmte TicTacToe mit ReactJS, um einzelne Konzepte von React zu zeigen.",
